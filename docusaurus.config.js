...
const config = {
  ...
  // Change to site url
  url: "https://policy.greensoftware.foundation/",
  baseUrl: "/",
  onBrokenLinks: "throw",
  ...
  themeConfig:
    ...
    ({
      navbar: {
        ...
        logo: {
          alt: "Green Software Policy Working Group Logo",
          src: "img/logo.svg",
        },
        items: [
          {
        ...
        links: [
          {
            ...
            items: [
              {
                label: "Github",
                href: "https://github.com/Green-Software-Foundation/policy_wg", // Change to project repo
              },
              {
                label: "Website",
